package com.cas.flutterdatawedge
...
class MainActivity : FlutterActivity() {
    private val COMMAND_CHANNEL = "com.cas.flutterdatawedge/command"
    private val SCAN_CHANNEL = "com.cas.flutterdatawedge/scan"
    private val PROFILE_INTENT_ACTION = "com.cas.flutterdatawedge.SCAN"
        ...
        return object : BroadcastReceiver() {
            override fun onReceive(context: Context, intent: Intent) {
                if (intent.action.equals(PROFILE_INTENT_ACTION)) {
                    ...
                    val scanData: String = intent.getStringExtra(DWInterface.DATAWEDGE_SCAN_EXTRA_DATA_STRING) ?: ""
                    val symbology: String = intent.getStringExtra(DWInterface.DATAWEDGE_SCAN_EXTRA_LABEL_TYPE) ?: ""
